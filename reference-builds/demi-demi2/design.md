...
Source: Demi Lightweight Guidelines V1.0 (`demi/figma/brandbook-frames/`), palette p18,
...
table; matches Demi's own "quiet confidence and restraint".
...
- No impacts, no risers, no glitch. Demi is "omnipresent, not intrusive".
...
- Never let a graphic replace her at the direct ask.
