...
The current Nader vertical. Nine beats cut out of a finished long-form with **no new recording and
no new transcription**, alternating split-screen and card states, with the card collapsing inside
its own rect.

Shipped result: `reference-cuts/nader-vid62-incogni-short.mp4` (720p proxy).
...
Volumes for this client after three rounds: **minimum 0.050, median 0.064, ceiling 0.082.** He
halves it every time he says "loud". These are roughly a quarter of the shreyansh house range.
