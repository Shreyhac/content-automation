...
"/Volumes/Shreyansh/nader new video/raw/Incogni Video 3.mov", which is 399.8s and is
...
owner's "why is Nader's frame always moving left-right"). crop_y puts his crown on
