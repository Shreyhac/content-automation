# vid62 short: Nader ep5, vertical cut
...
Code NADER, 60% off the annual plan. incogni.com/nader
...
| 8 | 342.64-346.80 | 4.17 | "You can use the code NADER for 60% off Incogni's annual plan." | CARD 2.3s, then off |
...
- **His email is not in the cut.** `p3-activity` carried `media@nadernejad.com` in the
...
- **Not sent to Nader.** Per the repo rule, this is out for your eyes first.
