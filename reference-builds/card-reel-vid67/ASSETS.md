...
Shipped result: `reference-cuts/card-reel-vid67-launch-your-agent.mp4` (720p proxy).
Delivered original `out/vid67-final.mp4`: **1057 frames, 2160x3840 @ 30fps, 38.28 Mbps, 35.233333s,
168.6 MB.** The creator's master runs 33.15 Mbps, so delivery sits above it, which is the rule.
...
Master `/Volumes/EXTERNAL/creator set 4/edited/agentss.mp4`: 35.233s, 2160x3840 HEVC,
33.15 Mbps, 30fps, the creator's own manual cut, no CapCut watermark (checked top-left and bottom-right at
...
and `Gaegu-700`, which every card-reel build from hf63 onward loads**. All of them live in
`library/fonts/`.
