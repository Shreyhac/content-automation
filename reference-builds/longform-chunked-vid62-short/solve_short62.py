...
# ---- zones (identical to vid59's short; this is the client's format, not a per-film choice)
UI          = 1600
TOP         = 150
GFX         = (150, 640)
CAP_HI      = (674, 826)
...
def main():
    ...
    # client note asked for exactly that ("show the presenter in full frame here"). It is
