...
`reference-builds/gaurav-vid47/`. He specified the split by sending a frame from vid41 (hf41);
the no-zoom correction is a standing instruction, not a one-off ("No need to zoom his frame.
Just keep the original frame.").
...
a new room; same head size (Vision face-width .242 vs .239) but he sat ~490px higher and
wandered vertically nearly twice as far. Reproducing take one's crop put his chin past y1600 on
